...
class WeatherService {
  ...
  String apiKey = '3c59dcca6c79e4a1addf7e5f35dab914';
  ...
  void getCurrentWeatherData({
    ...
    final url = '$baseUrl/weather?q=$city&lang=ru&appid=$apiKey';
    //print(url);
  ...
  void getFiveDaysThreeHoursForcastData({
    ...
    final url = '$baseUrl/forecast?q=$city&lang=ru&appid=$apiKey';
    print(url);
    ApiRepository(url: '$url', payload: null).get(
        beforeSend: () => {},
        onSuccess: (data) => {
